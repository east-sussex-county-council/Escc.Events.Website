<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dates.aspx.cs" Inherits="Escc.Events.Website.Dates" %>
...
<asp:Content runat="server" ContentPlaceHolderID="content">
    ...
    <section>
        ...
        <Events:ViewController ID="viewController" runat="server" EventListControlId="eventList" PageTitleControlId="pageTitle" MetadataControlId="metadata/headcontent" PagingControllerId="pagingController" DefaultDateRange="CurrentMonth" />
